import{B as d}from"./index-BzP4nq_j.js";import{d as _,r as b,m as E,o as V,V as L,e as o,T as S,B as H,z as B,c as N,a as t,w as n,i as s,t as f,j as g,b as P,_ as R}from"./index-CTo9axDr.js";const r=_({name:"Tooltip",props:{content:{type:String,default:""},position:{type:String,default:"top"},offset:{type:Number,default:10}},setup(u,{slots:p}){const y=b(null),h=b(null),e=b(!1),k=b({}),c=b(u.position),C=E(()=>["absolute px-5 py-3 text-center text-gray-600 bg-white rounded-lg shadow-lg dark:shadow-none shadow-gray-200 dark:bg-gray-800 dark:text-white","transition-opacity duration-200 z-50","min-w-[12rem] max-w-xs",`tooltip-${c.value}`]),m=()=>{if(!y.value||!h.value)return;c.value=u.position;const v=y.value.getBoundingClientRect(),a=h.value.getBoundingClientRect(),T=document.documentElement.clientWidth,w=document.documentElement.clientHeight,i=8;let l=0,x=0;x=v.left+(v.width-a.width)/2,c.value==="top"?l=v.top-a.height-u.offset:l=v.bottom+u.offset,l<i&&c.value==="top"?(c.value="bottom",l=v.bottom+u.offset):l+a.height>w-i&&c.value==="bottom"&&(c.value="top",l=v.top-a.height-u.offset),x<i?x=i:x+a.width>T-i&&(x=T-a.width-i),l<i&&l+a.height>w-i?c.value==="top"?l=i:l=w-a.height-i:(l<i&&(l=i),l+a.height>w-i&&(l=w-a.height-i)),k.value={position:"fixed",top:`${l}px`,left:`${x}px`,zIndex:"9999"}},M=()=>{e.value=!0,B(()=>{m(),B(()=>{m()})})},z=()=>{e.value=!1};return V(()=>{window.addEventListener("resize",m),window.addEventListener("scroll",m,{passive:!0})}),L(()=>{window.removeEventListener("resize",m),window.removeEventListener("scroll",m)}),()=>o("div",{class:"relative inline-block",ref:y},[o("div",{onMouseenter:M,onMouseleave:z,class:"w-full"},[p.trigger?p.trigger():o("button",{class:"text-gray-600 transition-colors duration-200 focus:outline-none dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500"},[o("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"2",stroke:"currentColor",class:"w-6 h-6"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z"},null)])])],40,["onMouseenter","onMouseleave"]),o(S,{to:"body"},{default:()=>[o(H,{name:"tooltip-fade"},{default:()=>[e.value&&o("div",{ref:h,class:C.value,style:k.value},[p.content?p.content():o("p",{class:"truncate"},[u.content])],6)]})]}),o("style",{scoped:!0},[`
        ...
        `],8,["scoped"])],512)}}),j={class:"p-8 space-y-12"},D={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},$={class:"flex items-center gap-4"},I={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},W={class:"flex flex-wrap gap-4"},O={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},U={class:"flex items-center"},q={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},A={class:"flex gap-6 items-center"},F={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},G={class:"flex gap-4 items-center"},J={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},K={class:"flex gap-4"},Q={class:"bg-gray-50 p-6 rounded-lg dark:bg-gray-800"},X={class:"flex items-center gap-4"},Y=`<Tooltip content="这是一个简单的提示">
  <template #trigger>
