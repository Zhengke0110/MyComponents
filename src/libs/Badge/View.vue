    ...
    <div class="container mx-auto px-4 py-8 text-gray-900 dark:text-white">
        ...
        <section class="mb-10">
            ...
            <CodePreview :code="projectTagsCardCode" :initiallyExpanded="false">
                <div
                    class="max-w-md rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                    <div class="mb-3 flex items-center justify-between">
...
import { basicColorCode, grayScaleCode, thematicColorCode, variantSoftCode, variantSolidCode, variantOutlineCode, sizeOptionsCode, roundedOptionsCode, interactiveBadgesCode, productLabelsCode, statusLabelsCode, notificationBadgesCode, userStatusCardCode, systemStatusCardCode, projectTagsCardCode } from './code'
