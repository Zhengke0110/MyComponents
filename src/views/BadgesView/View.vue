      ...
      <div class="mb-6 rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="mb-4 flex flex-wrap gap-2">
          ...
          <button 
            ...
            @click="setLightTheme"
            :class="{'ring-2 ring-blue-300 dark:ring-indigo-400': themeMode === 'light'}"
          >
          ...
          <button 
            ...
            @click="setDarkTheme"
            :class="{'ring-2 ring-gray-500 dark:ring-gray-400': themeMode === 'dark'}"
          >
          ...
          <button 
            ...
            @click="useSystemTheme"
            :class="{'ring-2 ring-gray-400 dark:ring-gray-500': themeMode === 'system'}"
          >
        ...
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700/30">
          ...
          <pre class="overflow-x-auto rounded bg-gray-100 p-3 text-xs text-gray-800 dark:bg-gray-800 dark:text-gray-200">{{ themeScript }}</pre>
        </div>
      </div>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
        <div class="space-y-4">
          ...
          <ul class="ml-6 list-disc space-y-2 text-gray-700 dark:text-gray-300">
            <li>根据语义选择合适的主题和颜色，如使用 <Badge text="success" theme="success" size="sm" /> 表示成功状态</li>
            <li>为不同重要性的信息选择不同的变体，如使用 <Badge text="solid" variant="solid" size="sm" /> 强调重要信息</li>
            <li>根据上下文环境选择合适的尺寸，如在紧凑界面中使用 <Badge text="sm" size="sm" /></li>
            <li>当需要用户交互时，启用 <Badge text="clickable" clickable size="sm" /> 属性</li>
          ...
          <div class="rounded-lg border border-blue-100 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-900/20">
            ...
            <p class="text-sm text-blue-700 dark:text-blue-300">
              Badge 组件已内置支持暗色模式，无需额外配置。只要在应用的根元素上添加 <code class="rounded bg-blue-100 px-1 py-0.5 font-mono dark:bg-blue-800/60">.dark</code> 类，
