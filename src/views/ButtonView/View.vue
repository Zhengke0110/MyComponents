  ...
  <div class="container mx-auto px-4 py-8 text-gray-900 dark:text-white">
    ...
    <div class="mb-10 flex items-center gap-4">
      <div class="flex items-center gap-2">
        ...
        <button
          class="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 transition-all focus:outline-none dark:bg-blue-600"
          @click="toggleDark()">
          <span :class="[
      ...
      <Button :variant="isDark ? 'solid' : 'outline'" theme="primary" icon="icon-[carbon--sun]" v-if="isDark"
        @click="toggleDark(false)">
        切换到亮色模式
      </Button>
      <Button :variant="isDark ? 'outline' : 'solid'" theme="primary" icon="icon-[carbon--moon]" v-else
    ...
    <!-- 按钮变体 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">按钮变体</h2>

      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">实心按钮 (solid)</h3>
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">柔和按钮 (soft)</h3>
      <div class="mb-4 flex flex-wrap gap-4">
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">描边按钮 (outline)</h3>
      <div class="mb-4 flex flex-wrap gap-4">
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">幽灵按钮 (ghost)</h3>
      <div class="flex flex-wrap gap-4">
    ...
    <!-- 按钮尺寸 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">按钮尺寸</h2>
    ...
    <!-- 带图标的按钮 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">带图标的按钮</h2>
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">仅图标按钮</h3>
      <div class="flex flex-wrap items-center gap-4">
    ...
    <!-- 状态按钮 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">状态按钮</h2>
      <div class="flex flex-wrap items-center gap-4">
    ...
    <!-- 块级按钮 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">块级按钮</h2>
    ...
    <section class="mb-10">
      ...
      <div class="mb-6 rounded-lg border border-gray-200 p-6 dark:border-gray-700 dark:bg-gray-800">
        <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">暗色模式下的按钮样式</h3>
        ...
        <div class="space-y-6">
          <div>
            <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">实心按钮</h4>
          ...
          <div>
            <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">柔和按钮</h4>
            <div class="flex flex-wrap gap-3">
              <Button variant="soft" theme="primary">主要</Button>
              <Button variant="soft" theme="success">成功</Button>
              <Button variant="soft" theme="warning">警告</Button>
          ...
          <div>
            <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">描边按钮</h4>
            <div class="flex flex-wrap gap-3">
              <Button variant="outline" theme="primary">主要</Button>
              <Button variant="outline" theme="success">成功</Button>
              <Button variant="outline" theme="warning">警告</Button>
          ...
          <div>
            <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">幽灵按钮</h4>
            <div class="flex flex-wrap gap-3">
              <Button variant="ghost" theme="primary">主要</Button>
              <Button variant="ghost" theme="success">成功</Button>
              <Button variant="ghost" theme="warning">警告</Button>
    ...
    <!-- ColorType 所有颜色展示 -->
    <section class="mb-10">
      <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">所有颜色按钮</h2>

      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">灰色系</h3>
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">暖色系</h3>
      <div class="mb-6 flex flex-wrap gap-3">
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">绿色系</h3>
      <div class="mb-6 flex flex-wrap gap-3">
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">蓝色系</h3>
      <div class="mb-6 flex flex-wrap gap-3">
      ...
      <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">紫粉色系</h3>
      <div class="mb-6 flex flex-wrap gap-3">
      ...
      <div class="mt-8 rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-800">
        <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">不同变体的颜色展示</h3>

        <div class="space-y-6">
          <div v-for="(variant, idx) in ['solid', 'soft', 'outline', 'ghost'] as const" :key="idx">
            <h4 class="mb-2 text-base font-medium text-gray-900 dark:text-white">{{ variantNames[variant] }}</h4>
            <div class="flex flex-wrap gap-3">
    ...
    <section class="mb-10">
      ...
      <div
        ...
        <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">表单提交</h3>
        <div class="space-y-4">
          <div class="space-y-2">
      ...
      <div
        class="mb-6 max-w-md rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">确认操作</h3>
      ...
      <div class="max-w-md rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
        <h3 class="mb-3 text-lg font-medium text-gray-900 dark:text-white">编辑器工具栏</h3>
        <div class="flex flex-wrap gap-2">
          <Button variant="ghost" icon="icon-[carbon--bold]" />
          <Button variant="ghost" icon="icon-[carbon--italic]" />
          <Button variant="ghost" icon="icon-[carbon--underline]" />
          <Button variant="ghost" icon="icon-[carbon--strikethrough]" />
          <div class="mx-2 h-8 border-l border-gray-300 dark:border-gray-600"></div>
          <Button variant="ghost" icon="icon-[carbon--align-horizontal-left]" />
          <Button variant="ghost" icon="icon-[carbon--align-horizontal-center]" />
          <Button variant="ghost" icon="icon-[carbon--align-horizontal-right]" />
          <div class="mx-2 h-8 border-l border-gray-300 dark:border-gray-600"></div>
